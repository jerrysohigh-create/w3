(function () {
  ...
  function showConsent() {
    ...
    panel.innerHTML = '<strong>PRIVACY / OPTIONAL ANALYTICS</strong><p>W3 僅在你同意後載入 GA4，用於衡量頁面訪問與站內導流；拒絕不會影響網站功能。詳情見 <a href="' + (document.body.dataset.root || "") + 'privacy-policy.html">Privacy Policy</a>。</p><div class="analytics-consent__actions"><button type="button" data-analytics-accept>ALLOW ANALYTICS</button><button type="button" data-analytics-reject>CONTINUE WITHOUT</button></div>';
