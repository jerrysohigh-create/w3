(function () {
  ...
  if (header) {
    header.innerHTML =
      '<div class="statusbar"><div class="wrap"><span class="status-preview">W3 SYSTEM / PREVIEW</span><div class="status-meta"><a href="https://www.magne.ai/en/" target="_blank" rel="noopener noreferrer" aria-label="在新視窗開啟 MAGNE.AI 產品主站">MAGNE.AI ↗</a><a href="https://web3.magne.ai/" target="_blank" rel="noopener noreferrer" aria-label="在新視窗開啟 WEB3.MAGNE.AI 歷史白皮書">WHITEPAPER ↗</a><a class="status-s2 is-checking" data-s2-global-status href="' + root + 'season-2.html" aria-label="正在檢查 Season 2 資料狀態">S2: CHECKING</a><span id="site-clock">--:--:--</span></div></div></div>' +
