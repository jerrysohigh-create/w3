(function () {
  ...
  if (header) {
    header.innerHTML =
      '<div class="statusbar"><div class="wrap"><span class="status-preview">W3 SYSTEM / PREVIEW</span><div class="status-meta"><a href="https://www.magne.ai/en/" target="_blank" rel="noopener noreferrer" aria-label="Open the MAGNE.AI product site in a new window">MAGNE.AI ↗</a><a href="https://web3.magne.ai/" target="_blank" rel="noopener noreferrer" aria-label="Open the archived WEB3.MAGNE.AI whitepaper in a new window">WHITEPAPER ↗</a><a class="status-s2 is-checking" data-s2-global-status href="' + root + 'season-2.html" aria-label="Checking Season 2 data status">S2: CHECKING</a><span id="site-clock">--:--:--</span></div></div></div>' +
